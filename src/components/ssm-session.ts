...
export const useCreateSsmSession = ()  => {
    ...
    function parseUuid(buf: Uint8Array): string {
    ...
    function agentMessageToBuffer(payload: ReturnType<typeof buildAgentMessage>): Uint8Array {
